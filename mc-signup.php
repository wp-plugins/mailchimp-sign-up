 ...
 * Description: MailChimp signup form. Barebones ajax email input. 
 * Version: 0.1
...
/* Wordpress enqueue scripts */	
	...
	$handle ='mc_email';
	$src = plugins_url( '/mailchimp-signup/assets/js/mc_subscribe.js');
	$deps = array("jquery");
	wp_enqueue_script( $handle, $src, $deps);
	$src =  plugins_url( '/mailchimp-signup/assets/css/mailchimp_signup.css' );
...
/* Wordpress admin menu */	
	...
	add_filter("plugin_action_links_mailchimp-signup/mc-signup.php", 'settings_link' );
...
?>
 <div style="margin:0px 0px 0px 10px;">
       <div style="margin:20px 0px 0px 0px;"><img src="<?php echo plugins_url( '/mailchimp-signup/assets/images/chimp.png'); ?>" /></div>
    ...
    <h3>Form Options</h3>
        ...
        <div style="font-size:11px; margin-top:10px;"><p><img src="<?php  echo plugins_url( '/mailchimp-signup/assets/images/jp_logo_orange.png'); ?>" style="float:left"/> MailChimp sign up plugin by <a href="http://jasonprescher.com/" style="color:#D16249; text-decoration:none; font-style:italic">Jason Prescher</a></p></div>
        </div> 
        </div> 
